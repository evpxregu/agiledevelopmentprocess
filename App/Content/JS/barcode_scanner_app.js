$(function() {
    ...
    detectionFunction =function(result) {
        ...
        if ( App.lastResult !== code) {
            ...
            GetProductInfo(format,code)
        }
    }
    
    Quagga.onDetected(detectionFunction); 
    
    
    //todo RH: check what coding styles/techniques are used in modern javascript development, 
    //todo RH 2: perhaps change JS to TS?
    function GetProductInfo(code_type, code_number)
    {
